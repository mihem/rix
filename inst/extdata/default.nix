# This file was generated by the {rix} R package v0.14.7 on 2025-02-07
# with following call:
# >rix(date = "2025-01-27",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "e5f50cefadde63bb3a16531394ac4db4f92e5bc5"),
#  > ide = "other",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-01-27.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "e5f50cefadde63bb3a16531394ac4db4f92e5bc5";
        sha256 = "sha256-KxwsPuOUQuwB2eZUPg341tDHDBgmcchCmKLIroZ1MWE=";
      };
