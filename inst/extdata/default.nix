# This file was generated by the {rix} R package v0.14.7 on 2025-02-05
# with following call:
# >rix(date = "2025-01-27",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "4c5c9fb25a36b889fe150d5fa849ddda1931d066"),
#  > ide = "other",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-01-27.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "4c5c9fb25a36b889fe150d5fa849ddda1931d066";
        sha256 = "sha256-RULoo/NdEVdyZuQU3hVquPmySIsahZEyrnA1pS85bRo=";
      };
